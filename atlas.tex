...
of about $500\mu$m. According to \eqn\eqref{eq:sagitta},
...
where the rates are too high ($>150$ Hz/cm$^2$) and CSCs
are used instead. 
...
as in \fig\ref{}.
An chamber is built from 2 multilayers separated by a spacer of ... length
