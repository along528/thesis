There was a moment when the world thought they 
...
%There was the peculiar discovery by Compton in 1923 \cite{PhysRev.21.483} that light had a particle nature, in the form of photons
...
%Its existence couldn't be explained by the standard class of models.  It required something new. This lead to the confirmation of the quark model to describe the hadrons and the proposal of a new particle: the charm.  It predicted an entirely new slew of composite particles, but at least they could be explained now by a short list of constituent particles, now known as the quarks: the up, down, strange, and charm, as well as the bottom and top discovered later in 1977 \cite{Herb:1977ek} and 1995 \cite{PhysRevLett.74.2632,PhysRevLett.74.2626}, respectively.
%implying the existence of some new class of particles (now associated with the discovery of the strange quark).  
...
%Then came the \emph{November Revolution} with the discovery of the $J/\psi$ in November of 1974 \cite{PhysRevLett.33.1404,PhysRevLett.33.1453}.  Its existence couldn't be explained by the standard class of models.  It required something new. This lead to the confirmation of the quark model to describe the hadrons and the proposal of a new particle: the charm.  It predicted an entirely new slew of composite particles, but at least they could be explained now by a short list of constituent particles, now known as the quarks: the up, down, strange, and charm, as well as the bottom and top discovered later in 1977 \cite{Herb:1977ek} and 1995 \cite{PhysRevLett.74.2632,PhysRevLett.74.2626}, respectively.
...
Once these tools have been described, 
