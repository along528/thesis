...
The performance of the final description for those simulated backgrounds
...
This is 5 equations and 16 unknowns. The four unknowns, $N^{\textrm{Data}}_{A,B}$,
...
An overall 50\% uncertainty is place on the normalization of these cross-sections.
