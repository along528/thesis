...
We may check how well the NLO $ZZ$ MC prediction and 
...
%\begin{figure}[htp]
%\centering
%\includegraphics[width=0.495\textwidth]{figures/ZZ_CR/ZZ_CR_lep_pt.eps}
%\includegraphics[width=0.495\textwidth]{figures/ZZ_CR/ZZ_CR_m4l.eps}
%\includegraphics[width=0.495\textwidth]{figures/ZZ_CR/ZZ_CR_m12.eps}
%\includegraphics[width=0.495\textwidth]{figures/ZZ_CR/ZZ_CR_m34.eps}
%\caption{$ZZ$ control region with two separate SFOS pairs. 
