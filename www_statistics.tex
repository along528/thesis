...
\begin{figure}[ht!]
\centering
\includegraphics[width=0.95\columnwidth]{figures/statistics/significance/combination.png}
...
\begin{equation}
\sigma^{\textrm{Fiducial}}_{\textrm{Expected}} = 309.2  ^{+434}_{-338} (\textrm{stat}) ^{+316}_{-342} (\textrm{sys}) \textrm{ab}
\end{equation}
and the observed fiducial cross-section is
\begin{equation}
\sigma^{\textrm{Fiducial}}_{\textrm{Observed}} = 315.1  ^{+347}_{-334} (\textrm{stat}) ^{+326}_{-348} (\textrm{sys}) \textrm{ab} ~.
\end{equation}
The expected and observed values and uncertainties are summarized
in terms of the signal strength in \fig\ref{fig:summary_mu_3l}
for the combined fully-leptonic  measurement as well as for the individual
fully-leptonic signal regions.
...
\begin{figure}[ht!]
\centering
\includegraphics[width=0.95\textwidth]{figures/statistics/measurement/interval/combination.png}
...
\begin{figure}[htb]
\centering
\includegraphics[width=0.95\textwidth]{figures/statistics/summary_mu_3l.pdf}
\caption{The expected and 
observed best fit signal strength, $\mu$, 
and uncertainties for each of the fully-leptonic signal regions
and for the combination of the three regions.}
\label{fig:summary_mu_3l}
\end{figure}
