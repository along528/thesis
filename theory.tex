...
\begin{figure}[ht]
\centering
%\includegraphics[width=.2\textwidth]{figures/template.pdf}
\vspace{5 mm}
...
are shown in \fig\ref{fig:theory_feynman_couplings_tgc}
...
Measurements sensitive to $WW\gamma\gamma$ have been performed 
...
up-type quark (anti-quark) and down-type anti-quark (quark). The
outgoing boson lines are all $W$ bosons.}
