...
\frac{g'}{g} = \tan\theta_W
\end{equation}
The fundamental parameters of the EW theory 
are not determined \emph{a priori}, 
but the theory can be completely specified
after measuring only three.
...
The V-A structure of the weak interactions is captured
by assigning charges to the SM fermions 
such that they satisfy \eqn\eqref{eq:ewcharges} as listed
in \tab\ref{tab:ewcharges}.
