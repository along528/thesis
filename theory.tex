...
The MSTW 2008 and CT10 PDF sets are Hessian PDF sets that define
separate eigenvectors...
MSTW 08 has been shown to do a good job in general of describing
the LHC data, except possibly low rapidity lepton asymmetry data (cite),
which is sensitive to small $x$ ($x\approx 0.1$) valence quarks.
NNPDF uses a different method, which is split into separate MC sets...
NNPDF 3.0 is the most up-to-date with data from deep inelastic scattering
