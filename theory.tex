...
Upon EWSB, the two neutral gauge boson fields, $W_{\mu}^3$ and $B_{\mu}$, 
...
\end{aligned}
\end{equation}
which corresponds to the Feynman diagram to the left
in \fig\ref{fig:feyn_wcoupling}. It is this
...
\end{aligned}
\end{equation}
These terms correspond to the Feynman diagram to the right
in \fig\ref{fig:feyn_wcoupling}
...
\end{fmffile}
\vspace{2 mm}
\caption{Feynman diagrams of the $W$ boson coupling to leptons (left)
and to quarks (right). The charge and helicities of the fields must
follow those specified in the text. The quark generations can
