...
Carlo generator \vbfnlo, described in \cite{Arnold:2011wj}
and \cite{Arnold:2012xn},
which can generate partonic events at LO in QCD with
NLO cross-sections, 
...
to add the effects of beam remnant interactions and initial and 
...
the LO CTEQ6L1 PDF set~\cite{Pumplin:2002vw};
CT10 NLO~\cite{guzzi:2011sv}
is used in the NLO \vbfnlo~cross-section calculation.
The PDF used in the NLO \madgraph~generation 
and cross-section calculation is CTEQ6L1 
but this is re-weighted to CT10 NLO using a k-factor ranging
from 1.08 to 1.10.
For the reasons described in \sec\ref{sec:pdf},
renormalization and factorization scales must be chosen.
...
where each lepton has a \pt~of at least 5~\GeV. 
The \madgraph~samples 
include all decays of the $W$~boson, with a requirement 
that jets have a a \pt~of at least 10~\GeV~ but with no requirement
on the \pt~of the leptons.
...
\caption{Inclusive and fiducial cross-sections at NLO 
...
\begin{figure}[ht!]
\centering
\includegraphics[width=.40\columnwidth]{figures/pdf/MADppm_total_cteq6l1.png}
\includegraphics[width=.40\columnwidth]{figures/pdf/MADpmm_total_cteq6l1.png}
\includegraphics[width=.40\columnwidth]{figures/pdf/MADppm_fiducial_cteq6l1.png}
\includegraphics[width=.40\columnwidth]{figures/pdf/MADpmm_fiducial_cteq6l1.png}
...
to different choices of factorization, $\mu_F$, and renormalization, $\mu_R$,
