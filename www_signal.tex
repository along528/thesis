...
The CT10 NLO PDF central value is used as the nominal value of the final estimate
...
determined by varying each of them independently up or down by a factor of 2. 
The impact of these variations on the cross-sections
are shown separately for the two different charge modes in \tab~\ref{tab:scaleVariation}.
The uncertainty is then determined by taking the maximum variations for each charge mode, 
...
\end{equation}
and for the fiducial cross-section.
