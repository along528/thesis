...
An example of the insantaneous luminosity in ATLAS can be seen for
...
the bottom portionis zoomed in to the length of the bunch crossing. 
...
the collisions do not occur inside the detetor. Instead, the decay products
...
for maitenance and upgrade work.  }
