...
\begin{figure}[ht]
\centering
~~~~~~~~~\includegraphics[width=.7\textwidth]{figures/lhc/integratedlumi.png}
\includegraphics[width=.7\textwidth]{figures/lhc/pileup.png}
\caption{ (Top) The integrated luminosity as a function of time in 2012. The amount
...
(Bottom) The distribution of pileup interactions, parameterized
