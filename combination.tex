...
\begin{figure}[ht]
\centering
\includegraphics[width=.45\textwidth]{figures/aQGC/2l2j_fiducial_ununit_noratio.png}
\includegraphics[width=.45\textwidth]{figures/aQGC/2l2j_fiducial_3TeV_noratio.png}
\includegraphics[width=.45\textwidth]{figures/aQGC/2l2j_fiducial_2TeV_noratio.png}
\includegraphics[width=.45\textwidth]{figures/aQGC/2l2j_fiducial_1TeV_noratio.png}
