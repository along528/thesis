...
real leptons than fake leptons. We will call this the ``tight'' selection.
...
in this selection as $n_L$. The number of real leptons that fall in 
both regions can be called $n_R$. The number of real leptons 
...
%$n_R$, $n_F$ is the number that pass loose and tight

%start with one category and one lepton and add in bins and more leptons
