...
A fiducial phase space or fiducial region is defined purely
using truth information (generator information before
being passed through ATLAS reconstruction) as the region
the analysis is sensitive to. We define our fiducial region
...
statistical uncertainties after the entire fiducial selection
are summarized in each channel for both 
generators in \tab\ref{tab:fiducial_cross_sections}.
They are seen to be in good agreement between both generators.


A summary of the signal sample phase space and cross-sections is
